 ...
 */
package takehome1.takehomewebservice;
...
public class controller {
    ...
    public String buyer(@RequestParam(value="nama") String nama,
        ...
        model.addAttribute("harga","Rp " +hargabr); //harga barang
        model.addAttribute("total", "Rp " + totbr); // total sebelum barang didiskon
        model.addAttribute("totalakhir", "Rp " + diskon ); // total akhir
...
//  Keterangan Diskon
    ...
    public String getKembalian(int uangBayar, int getPotongan){
        ...
        if(uangBayar >= getPotongan){
            ...
            hasil = "Tidak ada kembalian karena uang anda kurang";
        }
